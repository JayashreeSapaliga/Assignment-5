...
{
    if($balance<500){
        echo "Minimum balance must be 500<br/>";
    }
    else {
        mysqli_query($mysql, "INSERT INTO Customer(accno,cust_name,cust_address,acc_type,balance) VALUES('$accno','$name','$address','$acc_type','$balance')");
